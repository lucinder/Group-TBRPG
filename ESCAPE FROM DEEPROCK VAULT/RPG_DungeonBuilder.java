            ...
            if(j == levelLength){
               ...
               if(i == 1){ // load first boss dialogue
                  cur.setSpecialDialogue(new String[]{
                     "The first thing you notice as you enter the room is the metallic smell of blood.",
                     "Covering your nose from the scent, you see stacks of books piled haphazardly around the chamber.",
                     "In the middle lies a corpse with its arms and legs chained to the floor.",
                     "Its clothing is in tatters, and its body is so mutilitated that it\'s impossible to identify any facial features.",
                     "A bloody pentagram is drawn encircling the corpse. You hear an evil cackle from the end of the room.",
                     "A tall, lanky man appears from the shadows with his skin and white hair paler than a ghost;",
                     "it is as if his very bones are protruding from his skin.",
                     "His jet black robe and staff exude a death-like aura, sucking the energy from your body."
                  });
               }
