...
public class RPG_Room {
   ...
   **/
   ...
   private String[] specialDialogue = new String[0];
   ...
   **/
   ...
   public RPG_Room(String id) throws InterruptedException{
      roomID = id;
   ...
   public RPG_Room(String id, String difficultyOverride) throws InterruptedException{
      roomID = id;
      String[] idParser = id.split("_");
      roomNumber = idParser[0];
      roomType = idParser[1];
   ...
   public void setSpecialDialogue(String[] newDialogue){ specialDialogue = newDialogue; }
   public void printSpecialDialogue() throws InterruptedException{
      for(String s : specialDialogue){ printStaggered(s); }
   }
   
   public boolean isFirstVisit(){ return firstVisit; }
   public void visit(){ firstVisit = false; }
   ...
   public void addRandomEnemy() throws InterruptedException{
      /**
      int cr = 0;
