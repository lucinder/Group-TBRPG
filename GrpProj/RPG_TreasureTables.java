...
public class RPG_TreasureTables{
   ...
   public static void fillMagicA(){
      ...
      magicA.put(3, RPG_Items_List.MAGICITEMS.SCROLL_2);
   }
   public static void fillMagicB(){
      ...
      magicB.put(2, RPG_Items_List.MAGICITEMS.SCROLL_2);
   ...
   public static void fillMagicC(){
      ...
      magicC.put(3, RPG_Items_List.MAGICITEMS.SCROLL_4);
      magicC.put(4, RPG_Items_List.MAGICITEMS.SCROLL_5);
   }
