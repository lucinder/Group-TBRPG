public class RPG_Spell extends RPG_Attack{
    ...
    //For Spell Atks
    public RPG_Spell(String name, String type, int[] dice, int manaCost, int mod, int prof) {
    ...
    public void setModifer(int modifier) {
        super.setModifier(modifier);
    }

    public void setToHit(int newProf) {
        super.setToHit(newProf);
    }
